...
import {
  ...
  routeProducts,
  routeAccounts,
} from "../../../store/slice/staffRouteSlice";
...
export default function StaffDashboard() {
  ...
  const ordersBtnHandler = () => {
    dispatch(routeOrders());
  };
  const productsBtnHandler = () => {
    dispatch(routeProducts());
  };
  ...
  const navigation = [
    {
      ...
      handler: dashboardBtnHandler,
      icon: HomeIcon,
      current: false,
    },
    {
      name: "Check Orders",
      handler: ordersBtnHandler,
      icon: FolderIcon,
      current: false,
    },
    {
      name: "User Accounts",
      handler: accountsBtnHandler,
      icon: UsersIcon,
      current: false,
    },
    {
      name: "Products",
      handler: productsBtnHandler,
      icon: CalendarIcon,
      current: false,
    },
  ];
